...
% \usepackage[letter, top=2.5cm, bottom=2.5cm, left=2cm, right=2cm]{geometry}
% \usepackage{fontspec}
...
\begin{equation}
  \ddot{\vec{r}}_{inertial} = \ddot{\vec{r}}_{rel} + 2\vec{\omega} \times \dot{\vec{r}}_{rel} + \vec{\omega} \times (\vec{\omega} \times \vec{r})
\end{equation}
